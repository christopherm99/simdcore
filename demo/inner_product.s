...
START2:
  ...
  outh s30 ;
  outl s30 ;
  mov s0, 0x8020 ; buffer address
  mov s1, 0 ; input byte
READC_2:
  inl s1 ;
  jeq READC_2 ; wait for input
  mov [s0 + 0], s1 ;
  mov s30, 2 ;
  add s0, s0, s30 ;
  cmp s1, 0xa ; newline
...
GO:
  ...
  mov v5, s2 ;    
  neg v5, v5 ;    
  add v0, v0, v5 ;       ; v0 = v0 - '0' (convert to numbers)
  add v1, v1, v5 ;       ; v1 = v1 - '0' (convert to numbers)
