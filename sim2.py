...
if __name__ == "__main__":
  parser = argparse.ArgumentParser(description="SIMD Simulator")
  parser.add_argument("input_file", help="Input binary file")
  parser.add_argument("result_register", help="Register to print result (ex: v2 or s4)")
  ...
  # PC * 4 : PC * 4 + 4
    ...
    match op[:5], op[5:]:
      case "00000", "000": 
        sregs[arg1] = sregs[arg2]
        changed_sregs.add(arg1)
      case "00000", "001": 
        sregs[arg1] = memory[sregs[arg2] + arg3] << 8 | memory[sregs[arg2] + arg3 + 1]
        changed_sregs.add(arg1)
      case "00000", "010":
        memory[sregs[arg1] + arg2] = sregs[arg3] >> 8
        memory[sregs[arg1] + arg2 + 1] = sregs[arg3] & 0xFF
      case "00000", "011": 
        sregs[arg1] = arg2 << 8 | arg3
        changed_sregs.add(arg1)
      case "00000", "100": 
        vregs[arg1][:] = vregs[arg2]
        changed_vregs.add(arg1)
      case "00000", "101":
        for i in range(16): 
          vregs[arg1][i] = memory[sregs[arg2] + arg3 + i]
          changed_vregs.add(arg1)
      case "00000", "110":
        for i in range(16): memory[sregs[arg1] + arg2 + i] = vregs[arg3][i]
      case "00000", "111":
        for i in range(16): 
          vregs[arg1][(i*2):(i*2)+2] = from_np(np.half(sregs[arg2])) if (arg3 >> i) & 1 else vregs[arg1][(i*2):(i*2)+2]
          changed_vregs.add(arg1) # ?
      case "00001", "000": 
      ...
      case "00001", "010": 
        ...
        changed_sregs.add(arg1)
      case "00001", "011": 
        sregs[arg1] = sregs[arg2] // sregs[arg3] # Need to set a flag for div by zero.
        changed_sregs.add(arg1)
      case "00001", "100": 
        sregs[arg1] = sregs[arg2] & sregs[arg3]
        changed_sregs.add(arg1)
      ...
      case "00001", "111": 
        ...
        changed_sregs.add(arg1)
      case "00010", "000": 
        vregs[arg1] = apply_func(np.add, vregs[arg2], vregs[arg3])
        changed_vregs.add(arg1)
      case "00010", "001": 
        vregs[arg1] = apply_func(np.multiply, vregs[arg2], vregs[arg3])
        changed_vregs.add(arg1)
      case "00010", "010": 
        vregs[arg1] = apply_func(np.negative, vregs[arg2])
        changed_vregs.add(arg1)
      case "00010", "011": 
        vregs[arg1] = apply_func(np.divide, vregs[arg2], vregs[arg3]) # Need to set a flag for div by zero.
        changed_vregs.add(arg1)
      case "00010", "100": 
        vregs[arg1] = apply_func(np.bitwise_and, vregs[arg2], vregs[arg3])
        changed_vregs.add(arg1)
      case "00010", "101": 
        vregs[arg1] = apply_func(np.bitwise_or, vregs[arg2], vregs[arg3])
        changed_vregs.add(arg1)
      case "00010", "110": 
        vregs[arg1] = apply_func(np.bitwise_xor, vregs[arg2], vregs[arg3])
        changed_vregs.add(arg1)
      case "00010", "111": 
        vregs[arg1] = apply_func(np.bitwise_not, vregs[arg2])
        changed_vregs.add(arg1)
      case "00011", "010": 
        vperm[:] = vregs[arg1][:]
        vperm_changed = True
...
if result_reg.startswith("v"):
    ...
    reg_value = as_np(vregs[reg_index], np.half).tolist()
